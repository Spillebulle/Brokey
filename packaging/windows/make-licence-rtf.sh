...
# will display. A plain text file is shown as one unwrapped line.
#
...
# shell: the inline version in a sibling failed differently in CI and on a
# developer's machine, which is the worst way for a build step to be wrong.
#
